...
func (app *application) logError(r *http.Request, err error) {
	// replace with prefered logger
	fmt.Println("request_method:%v, request_url: %v",r.Method,r.URL.String())
...
func (app *application) editConflictResponse(w http.ResponseWriter, r *http.Request) {
	message := `unable to update the record due to an edit conflict, please
try again`
